...
const Question6 = () => {
  ...
  const nextQuestion = () => {
    ...
    addScore(6, selectedOption,isCorrect); // Add selected answer to context
    navigate('/Question7');
  };
  ...
  // MCQ options
  const options = [
    { value: '1', label: '2 * 2 * 2', correct: true }, 
    { value: '2', label: '2 + 2 + 2', correct: false },
    { value: '3', label: '3*3', correct: false },
    { value: '4', label: '2/3', correct: false },
  ];
